import requests, threading, os, json, time, urllib.parse
...
# CONFIGURATION
# ========================
BOT_TOKEN = "8419010897:AAFBf7NBkWcDk9JYvCCUsjyQpFy6RqW3Ozg"
        ...
        <div class="container">
            ...
            <div class="data-container">
                ...
                <div class="empty-data">
                    No data stored yet. Send data via Telegram bot to get started!
                </div>
                {% endif %}
            </div>
            ...
            <footer>
                <p>Powered by Telegram Bot & Flask | {{ timestamp }}</p>
...
async def health_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    health_status = {
        "bot": "✅ Running",
        "server": "✅ Running" if SAVED_DATA is not None else "⚠️ Unknown",
...
def run_bot():
    ...
    print(f"🌐 Web Interface: {PUBLIC_URL}" + ("" if is_public_url(PUBLIC_URL) else " (Local only)"))
    print(f"🔗 RAW Endpoint: {RAW_URL}")
...
if __name__ == "__main__":
    print("🚀 Starting Enhanced RAW Data Service...")
    print("=" * 50)
